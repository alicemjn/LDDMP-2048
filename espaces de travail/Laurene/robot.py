...
# decide de lapparition du cube si le moouvementle plus frequent est bas et si le mouvement 
# effctuer est bas                 
...
#decide de la position du cube si le mouvement le moins frquant est haut et le mouvement effectuer est haut           
...
# decide de lapparition du cube si le moouvementle plus frequent est haut et si le mouvement effctuer est haut
    ...
    if a == "haut" and mouvement == "haut":
        for i in range(len(M)):  
            ...
            if case_vide:
                ...
                print(M)
                break    
#decide de la position du cube si le mouvement le moins frequent est bas et le mouvement effectuer est bas          
